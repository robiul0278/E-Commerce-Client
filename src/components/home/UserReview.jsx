...
const UserReview = () => {
    return (
<div className="mt-6 p-6 font-[sans-serif]">
          <div className="max-w-6xl mx-auto p-4">
              <div className="max-w-2xl mx-auto text-center">
                  <h2 className="text-gray-800 text-3xl font-extrabold">What our happy client say</h2>
                  <p className="text-sm text-gray-800 mt-6 leading-relaxed">Our customers love sharing their experiences at Mobile Shop. From personalized assistance to quality products, we’re proud to make every visit a memorable one.</p>
              </div>
              ...
              <div className="grid md:grid-cols-3 md:gap-6 max-md:gap-10 max-md:justify-center mt-16">
                  <div className="max-w-[350px] h-auto shadow-[0_2px_22px_-4px_rgba(93,96,127,0.2)] lg:p-8 p-4 rounded-md bg-white relative">
                      <div className="bg-[#571485] flex items-center justify-center w-16 h-16 max-lg:w-14 max-lg:h-14 rounded-full absolute -top-5 -right-5">
                      ...
                      <div className="flex items-center">
                          ...
                          <div className="ml-4">
                              ...
                              <div className="flex space-x-1 mt-2">
                                  <svg className="w-4 fill-[#571485]" viewBox="0 0 14 13" fill="none"
                      ...
                      <div className="mt-6">
                          <p className="text-sm leading-relaxed">I highly recommend Your Mobile Shop to anyone looking for great products and exceptional service!.</p>
                      </div>
                  </div>
                  ...
                  <div className="max-w-[350px] h-auto shadow-[0_2px_22px_-4px_rgba(93,96,127,0.2)] lg:p-8 p-4 rounded-md bg-white relative">
                      ...
                      <div className="mt-6">
                          <p className="text-sm leading-relaxed">The prices were competitive, and the variety of options was impressive. They even set up my phone and transferred all my data for free, which saved me so much time and effort..</p>
                      </div>
                  </div>
                  ...
                  <div className="max-w-[350px] h-auto shadow-[0_2px_22px_-4px_rgba(93,96,127,0.2)] lg:p-8 p-4 rounded-md bg-white relative">
                      ...
                      <div className="mt-6">
                          <p className="text-sm leading-relaxed">Mobile Shop stands out! The team was so patient and explained everything in detail, helping me decide on the best phone for my needs</p>
                      </div>
                  </div>
              </div>
          </div>
