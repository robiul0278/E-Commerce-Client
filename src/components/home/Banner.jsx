...
<div class="bg-gray-50 font-[sans-serif] relative p-5 container shadow-lg shadow-[#e9d9f3] mx-auto rounded overflow-hidden">
      <div class="grid sm:grid-cols-2 max-sm:gap-6">
        ...
        <Link to="products">          <button type="button" class="bg-[#4e0083] hover:bg-[#4f0083cc] text-white tracking-wide font-semibold text-sm py-3 px-6 rounded-xl mt-8">
            Get Started
          </button></Link>
        ...
        <div class="flex justify-end items-center p-2 bg-gradient-to-b from-[#4e0083] to-[#796089] rounded-bl-[230px] w-full h-full">
          <div class="h-72 w-72 rounded-full bg-gradient-to-tr from-[#4e0083] to-[#c19ed6] p-5">
            <img src="https://www.digitaltrends.com/wp-content/uploads/2023/10/iphone-15-plus-logo.jpg?fit=720%2C480&p=1" class="w-full h-full rounded-full object-cover border-8 border-white" alt="img" />
          </div>
        </div>
      </div>
      ...
      <div className="grid lg:grid-cols-4 container mx-auto md:grid-cols-2 gap-6 px-4 my-12">
