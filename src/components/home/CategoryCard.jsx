import { Camera, Headphones, Smartphone, Watch } from 'lucide-react';

const CategoryCard = () => {
  return (
    <div className="grid grid-cols-3 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-7 gap-5 py-4">
      <div className="flex flex-col items-center justify-center border border-gray-300 rounded-md py-8 hover:bg-red-500 transition hover:text-white w-full max-w-[150px]">
        ...
        <p className="mt-2 text-sm font-semibold">Phones</p>
      </div>
      <div className="flex flex-col items-center justify-center border border-gray-300 rounded-md py-8 hover:bg-red-500 transition hover:text-white w-full max-w-[150px]">
