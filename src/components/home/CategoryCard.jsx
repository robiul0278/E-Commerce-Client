...
const CategoryCard = () => {
  ...
  return (
    <ul className="grid grid-cols-4 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-8 xl:grid-cols-8 md:gap-5  lg:gap-5 gap-2 py-4">
      ...
      className="flex flex-col items-center cursor-pointer justify-center shadow shadow-slate-300 rounded-box p-2 md:p-5 lg:p-5 hover:bg-[#49B2FF] transition duration-300 hover:text-white w-full max-w-[150px] ">
